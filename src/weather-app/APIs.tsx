              ...
              <div className="md:px-6 md:flex md:justify-between md:gap-8 md:w-[100%] mx-auto p-0">
                          ...
                          {weather && (
                            <p className="temp text-[5rem] pr-8 text-white italic">
                              {activeUnit === "celsius"
                                ...
                                : Math.round(
                                    weather.current_weather.temperature * 1.8 +
                                      32
                                  )}
                              &deg;
                            </p>
                ...
                <section className=" md:w-[30%]">
                  <div className=" md:w-[100%] mt-8 pt-4 px-3 bg-[hsl(243,27%,20%)] rounded-lg">
                    ...
                    {dayDropdown && (
                      <div className="absolute flex justify-end w-[85%] mt-3 md:w-[37vw]">
                        <div className=" w-[210px] bg-[hsl(243,27%,20%)] px-2 -ml-1 rounded-lg border border-[hsl(252,17%,35%)]">
